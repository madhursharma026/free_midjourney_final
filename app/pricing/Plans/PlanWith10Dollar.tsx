...
export default function PlanWith10Dollar() {
            ...
            window.paypal.Buttons({
                ...
                createSubscription: function (data, actions) {
                    return actions.subscription.create({
                        ...
                        plan_id: `${process.env.NEXT_PUBLIC_PLAN_ID_OF_10_DOLLAR}`
                    });
                },
                onApprove: function (data, actions) {
                    localStorage.setItem('subscriptionID', data.subscriptionID)
                }
            }).render(`#paypal-button-container-${process.env.NEXT_PUBLIC_PLAN_ID_OF_10_DOLLAR}`);
        });
        ...
        <div className="bg-gray-50 pb-12 rounded-xl">
            <div className="bg-dark p-8 relative font-Mona_Bold rounded-lg">
                ...
                <div className="flex items-end space-x-2 justify-center">
                    <h2 className="heading text-white font-Mona_Regular">$10.00</h2>
                    <p className="text-base inline-block text-white capitalize">/ {10 * creditsPerUnit} Credit</p>
                </div>
            </div>
